...
// Add additional letter definitions as needed
// Example:
/*
...
void initFontTable() {
    ...
    fontTable[65].width = 12;  // 12 pixels wide
    fontTable[65].height = 24; // 24 pixels tall
    
    // Add additional letters as they are defined
    // Example:
    /*
    fontTable[66].data = Letter_B;  // B
